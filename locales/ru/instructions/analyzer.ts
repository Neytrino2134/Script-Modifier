...
export const analyzer = {
    ...
    'instruction.shot_filter_wide': 'Только Средние Планы',
    'instruction.desc.shot_filter_wide': 'ФИЛЬТР СТРОГИЙ: Используйте ТОЛЬКО Средние Планы (MS) или Средне-Общие (MWS). Крупные и Сверх-Общие планы запрещены. Описывайте персонажа по пояс/колени.',
    ...
    'instruction.desc.subject_hierarchy': 'НЕВИДИМЫЙ КОНТЕКСТ: Даже если в кадре только глаз, опишите ПОЗУ ТЕЛА: "Персонаж-1 сидит сгорбившись, оперевшись локтями. Крупный план глаза". ИИ иначе не поймет наклон головы.',
    ...
    'instruction.subject_hierarchy': 'Привязка Контекста',
    'instruction.motion_dynamics': 'Динамика Движения',
    'instruction.entity_limit': 'Лимит Энтити',
    'instruction.desc.entity_limit': 'СТРОГО ЗАПРЕЩЕНО использовать более 3 персонажей (Entity) в одном кадре. Разбивайте сцены на группы.',
};
