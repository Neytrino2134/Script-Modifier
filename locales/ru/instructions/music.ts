...
export const music = {
    'instruction.music_role': 'Роль Продюсера',
    'instruction.desc.music_role': 'Роль эксперта-композитора и автора текстов.',
    'instruction.music_input': 'Входные данные',
    'instruction.desc.music_input': 'Тема или идея, предоставленная пользователем.',
    'instruction.music_creative': 'Творческая Свобода',
    ...
    'instruction.desc.music_format': 'Строгая структура JSON для интеграции.',
};
