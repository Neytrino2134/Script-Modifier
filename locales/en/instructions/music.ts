...
export const music = {
    'instruction.music_role': 'Music Producer Role',
    'instruction.desc.music_role': 'Expert Composer and Lyricist role definition.',
    'instruction.music_input': 'Input Data',
    'instruction.desc.music_input': 'The theme or idea provided by the user.',
    'instruction.music_creative': 'Creative Freedom',
    ...
    'instruction.desc.music_format': 'Strict JSON structure for integration.',
};
