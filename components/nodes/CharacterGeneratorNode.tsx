...
const CharacterGeneratorNode: React.FC<NodeContentProps> = ({
    ...
    isGeneratingCharacterImage, onDetachCharacter
}) => {
                    ...
                    >
                        ...
                        <div className="flex space-x-3">
                            <div className="w-40 flex-shrink-0 space-y-2">
                                <div className="relative w-full aspect-square bg-gray-900/50 rounded-md flex items-center justify-center overflow-hidden">
                                {isImgLoading ? (
                                    ...
                                    <img src={`data:image/png;base64,${char.imageBase64}`} alt={char.name || "Character"} className="w-full h-full object-contain" />
                                ) : (
                                ...
                                <button
                                    ...
                                    disabled={isImgLoading || !char.prompt}
                            ...
                            <div className="flex-grow min-w-0">
                                ...
                                <div className="space-y-1 mt-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full text-xs p-2 bg-gray-800 border border-transparent rounded-md resize-y min-h-[60px] focus:outline-none focus:border-emerald-500 focus:ring-0 custom-scrollbar overflow-y-scroll"
                                        onWheel={e => e.stopPropagation()}
                                        onFocus={deselectAllNodes}
                                    />
                                </div>
