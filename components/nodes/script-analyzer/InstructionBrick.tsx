...
export const InstructionBrick = forwardRef<HTMLDivElement, InstructionBrickProps>(({ 
    id, label, originalText, translatedText, isCritical, isEnabled = true, isMandatory = false, onToggle, color = 'emerald', className = "", index, isHighlighted
}, ref) => {
    ...
    return (
        <div 
            ...
            onClick={() => !isMandatory && onToggle && onToggle(id)}
            ...
            <div className="flex flex-col flex-grow min-w-0">
                <div className="flex justify-between items-center mb-1 flex-shrink-0">
                    <div className="flex items-center gap-2">
                        {/* Dot indicator if no index */}
                        {index === undefined && <div className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${indicatorClass} shadow-[0_0_5px_rgba(0,0,0,0.5)]`} />}
                ...
                <div className="flex flex-col">
                    <div className={`leading-tight ${isEnabled ? 'text-gray-400' : 'text-gray-600'} text-[10px] mb-1`}>
                        {originalText}
                    </div>
