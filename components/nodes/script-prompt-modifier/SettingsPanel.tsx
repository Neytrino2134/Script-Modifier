            ...
            {!uiState.isSettingsCollapsed && (
                ...
                <div className="px-2 py-2 border-b border-gray-700 bg-gray-800/30 flex flex-wrap gap-x-3 gap-y-2">
                    ...
                    <div className="flex items-center gap-2 bg-gray-800/50 px-1.5 py-0.5 rounded border border-gray-700 group">
                        ...
                        />
                        <label className="text-xs text-gray-300 select-none cursor-pointer group-hover:text-emerald-400 transition-colors whitespace-nowrap">
                    ...
                    <div className="flex items-center gap-2 bg-gray-800/50 px-1.5 py-0.5 rounded border border-gray-700 group">
                         <CustomCheckbox
                            ...
                            className="h-3.5 w-3.5"
                        />
                        <label className="text-xs text-gray-300 select-none cursor-pointer group-hover:text-cyan-400 transition-colors whitespace-nowrap">
                    ...
                    <div className="flex items-center gap-2 bg-gray-800/50 px-1.5 py-0.5 rounded border border-gray-700 group">
                         <CustomCheckbox
                            ...
                            className="h-3.5 w-3.5"
                        />
                        <label className="text-xs text-gray-300 select-none cursor-pointer group-hover:text-white transition-colors whitespace-nowrap">
