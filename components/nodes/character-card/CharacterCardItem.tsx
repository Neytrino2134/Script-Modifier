...
import { CopyIcon, DetachIcon, PromptIcon, StarIcon, StarFilledIcon, SaveIcon, PlusIcon, PasteIcon, CloseIcon, ResetIcon } from '../../icons/AppIcons';
                        ...
                        {char.thumbnails[char.selectedRatio] || char.image ? (
                            <>
                                ...
                                <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity z-20">
                                    ...
                                    <ActionButton title={t('node.action.clear')} onClick={(e) => { e.stopPropagation(); onClearImage(); }} className="bg-black/60 p-1.5 rounded text-red-400 hover:text-white" tooltipPosition="left"><CloseIcon className="h-4 w-4" /></ActionButton>
                                </div>
                            </>
